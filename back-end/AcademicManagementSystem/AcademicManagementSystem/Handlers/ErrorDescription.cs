...
public static class ErrorDescription
{
    public static readonly Dictionary<string?, ErrorModel> Error = new Dictionary<string?, ErrorModel>()
    {
        ...
        { "E1122", new ErrorModel() { Message = "Current class is not exist", Type = "student-error-0038" } },
        { "E1123", new ErrorModel() { Message = "New class is not exist", Type = "student-error-0039" } },
