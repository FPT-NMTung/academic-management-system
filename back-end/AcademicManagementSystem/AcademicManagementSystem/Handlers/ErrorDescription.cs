...
public static class ErrorDescription
{
    public static readonly Dictionary<string, ErrorModel> Error = new Dictionary<string, ErrorModel>()
    {
        ...
        { "E0018", new ErrorModel() { Message = "centerId for CREATE SRO not found", Type = "sro-error-0003" } },
        { "E0019", new ErrorModel() { Message = "RoleId for CREATE SRO not found", Type = "sro-error-0004" } },
        { "E0020", new ErrorModel() { Message = "Duplicated MobilePhone for CREATE SRO", Type = "sro-error-0005" } },
        { "E0021", new ErrorModel() { Message = "Duplicated Email for CREATE SRO", Type = "sro-error-0006" } },
        { "E0022", new ErrorModel() { Message = "Duplicated EmailOrganization for CREATE SRO", Type = "sro-error-0007" } },
        { "E0023", new ErrorModel() { Message = "ProvinceId not found for CREATE SRO", Type = "sro-error-0008" } },
        { "E0024", new ErrorModel() { Message = "DistrictId not found for CREATE SRO", Type = "sro-error-0009" } },
        { "E0025", new ErrorModel() { Message = "WardId not found for CREATE SRO", Type = "sro-error-0010" } },
        { "E0026", new ErrorModel() { Message = "GenderId not found for CREATE SRO", Type = "sro-error-0011" } },
        { "E0027", new ErrorModel() { Message = "Duplicated citizenIdentityCardNo for CREATE SRO", Type = "sro-error-0012" } },
        { "E0028", new ErrorModel() { Message = "Birthday must match format yyyy/MM/dd for CREATE SRO", Type = "sro-error-0013" } },
        { "E0029", new ErrorModel() { Message = "CitizenIdentityCardPublishedDate must match format yyyy/MM/dd for CREATE SRO", Type = "sro-error-0014" } },
