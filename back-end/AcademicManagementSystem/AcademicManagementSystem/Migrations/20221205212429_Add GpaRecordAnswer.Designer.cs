...
namespace AcademicManagementSystem.Migrations
{
    ...
    [Migration("20221205212429_Add GpaRecordAnswer")]
    partial class AddGpaRecordAnswer
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AcademicManagementSystem.Context.AmsModels.GpaRecordAnswer", b =>
                {
                    b.Property<int>("AnswerId")
                        .HasColumnType("int")
                        .HasColumnName("answer_id");

                    b.Property<int>("GpaRecordId")
                        .HasColumnType("int")
                        .HasColumnName("gpa_record_id");

                    b.HasKey("AnswerId", "GpaRecordId");

                    b.HasIndex("GpaRecordId");

                    b.ToTable("gpa_record_answer");
                });
            ...
            modelBuilder.Entity("AcademicManagementSystem.Context.AmsModels.GpaRecordAnswer", b =>
                {
                    b.HasOne("AcademicManagementSystem.Context.AmsModels.Answer", "Answer")
                        .WithMany("GpaRecordsAnswers")
                        .HasForeignKey("AnswerId")
                        .OnDelete(DeleteBehavior.ClientNoAction)
                        .IsRequired();

                    b.HasOne("AcademicManagementSystem.Context.AmsModels.GpaRecord", "GpaRecord")
                        .WithMany("GpaRecordsAnswers")
            ...
            modelBuilder.Entity("AcademicManagementSystem.Context.AmsModels.Answer", b =>
                {
                    b.Navigation("GpaRecordsAnswers");
                });
