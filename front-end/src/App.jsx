  ...
  return (
    <Routes>
      ...
      >
        ...
        <Route
          path="/sro/manage-class/create"
          element={<ClassCreate modeUpdate={false} />}
        />
        <Route
          path="/sro/manage-class/:id/update"
          element={<ClassCreate modeUpdate={true} />}
        />
        <Route path="/sro/manage/student" element={<StudentScreen />} />
        <Route path="/sro/manage/student/:id" element={<StudentDetail />} />
        <Route
          path="/sro/manage/student/:id/update"
          element={<StudentUpdate/>}
        />
        <Route
          path="/sro/manage-class/:id/add"
      ...
      >
        ...
        <Route
          path="/admin/manage-course/course-family"
        ...
        <Route
          path="/admin/manage-course/module/:id/update"
          element={<ModuleUpdate />}
        />
        <Route path="/admin/account/sro" element={<SroScreen />} />
        <Route path="/admin/account/sro/:id" element={<SroDetail />} />
        <Route
          path="/admin/account/sro/create"
          element={<SroCreate modeUpdate={false} />}
        />
        <Route
          path="/admin/account/sro/:id/update"
          element={<SroCreate modeUpdate={true} />}
        />
        <Route path="/admin/account/teacher" element={<TeacherScreen />} />
        <Route path="/admin/account/teacher/:id" element={<TeacherDetail />} />
        <Route
          path="/admin/account/teacher/create"
          element={<TeacherCreate modeUpdate={false} />}
        />
        <Route
          path="/admin/account/teacher/:id/update"
          element={<TeacherCreate modeUpdate={true} />}
        />
      </Route>
